elements = {
    "Morte": {
        "desc": "Morte é a entidade do tempo. Ela busca os momentos vivenciados, distorcendo a percepção egóica da existência de cada indivíduo para seu próprio agrado.<br><br>A distorção temporal da Morte arruína a percepção carnal do Sangue.",
    ...
    "Sangue": {
        "desc": "Sangue é a entidade do sentimento. Ele busca a intensidade: dor, obsessão, paixão, amor, fome, ódio - tudo que envolve sentir uma emoção extrema agrada a entidade de Sangue.<br><br>Os sentimentos extremos do Sangue superam a razão e a calmaria do Conhecimento.",
        ...
        "outrasInfo": {
            "agts": {
                ...
                "agt_3": "<a href='https://twitter.com/Rakin/status/1471665341772271620?s=20'>Rakin</a> (interpretou Thiago e Arnaldo Fritz, atualmente interpreta Dante) e <a href='https://twitter.com/bastet_min/status/1472208316805824525?s=20'>Bastet</a> (interpreta o Henri) originalmente tiraram Energia, porém após mudanças no balanceamento, ambos os resultados atualmente seriam Sangue.",
            }
        }
    },

    "Energia": {
        "desc": "Energia é a entidade do caos. Tudo que não pode ser explicado, o intangível, a anarquia. A constante mudança, o calor e o frio, a luz e as trevas. Tudo que envolve a imprevisibilidade e a transformação agrada a entidade de Energia.<br><br>A transformação da Energia sobrecarrega os efeitos da Morte",
        ...
        "outrasInfo": {
            "agts": {
                ...
                "agt_3": "<a href='https://twitter.com/eujuliovictor/status/1472219964245430273?s=20e'>Júlio Victor</a> (responsável pela trilha sonora em Ordem Paranormal) e <a href='https://twitter.com/Orenjiro_Art/status/1471583193585397760?s=20'>Orenjiro</a> (ilustrador de Ordem Paranormal) realizaram o nosso teste e ambos possuem afinidade com Energia.",
            }
        }
    },
